...
class StockHolding: public WalletTransaction{
    ...
    public:
        StockHolding(string t, double balance, double stock_eq) 
            : WalletTransaction(balance, stock_eq), ticker(t) {}

        float buy_shares(float shares, float bought_shares){
            shares += bought_shares;
            return shares;
        }

        float sell_shares(float shares, float sold_shares){
            shares -= sold_shares;
            return shares;
        }
};
...
class BuyTransaction{
    ...
    public:
        ...
        float share_number(double total_purchase_price, double price){
...
class SellTransaction{
    ...
    public:
        ...
        float share_number(double sell_amount, double price){
