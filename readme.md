...
guessing_game.cpp: An interactive console-based number guessing game.

leap_year.cpp: Logic to determine if a given year is a leap year.
...
roi.cpp: Returns on Investment (ROI) calculator.
...
struct1.cpp: Demonstrations of C++ struct usage for data grouping.

data_types.cpp: Exploration of C++ primitive data types and memory allocation.

typedef_using.cpp: Demonstrations of type aliasing using typedef and using.
